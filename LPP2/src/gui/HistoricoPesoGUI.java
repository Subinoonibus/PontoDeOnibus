 ...
 * @author conta
 */
public class HistoricoPesoGUI extends javax.swing.JPanel {
 ...
 public HistoricoPesoGUI() {
    ...
    if (cpf != null && !cpf.isEmpty()) {
        ...
        var aluno = AlunoDAO.consultar(cpf);
        ...
        if (aluno != null) {
            ...
            List<HistoricoPeso> historico = historicoPesoDAO.consultarPorCliente(cpf);
            ...
            for (int i = 0; i < historico.size(); i++) {
                ...
                // Calcular o IMC
                double alturaMetros = aluno.getAltura() / 100.0; // Converter altura para metros
                double imc = registro.getPeso() / (alturaMetros * alturaMetros);

                model.addRow(new Object[]{
                    aluno.getCpf(), // Deixe em branco para CPF
                    aluno.getNome(), // Deixe em branco para Nome
                    registro.getPeso(),
                    registro.getAltura(),
