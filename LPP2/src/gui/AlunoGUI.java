...
public class AlunoGUI extends javax.swing.JFrame {
    ...
    private void readFromMySQL() {
        ...
        try (Connection conn = DriverManager.getConnection("jdbc:mysql://localhost/historico","root","@Ararazul13");
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        try{
            conn=DriverManager.getConnection("jdbc:mysql://localhost/historico","root","@Ararazul13");
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        if (cpf != null && !cpf.isEmpty()) {
            ...
            if (aluno != null) {
                ...
                model.setRowCount(0);
                model.addRow(new Object[]{aluno.getCpf(), aluno.getNome(), aluno.getDataNascimento(), aluno.getPeso(), aluno.getAltura()});
            } else {
    ...
    HistoricoPesoDAO weightHistDao = new HistoricoPesoDAO();
    weightHistDao.salvarPesoHistorico(aluno.getCpf(), (float) aluno.getPeso(), aluno.getAltura(), dataAtualizacao);
    
    // Atualizando a linha na tabela
    DefaultTableModel modelo = (DefaultTableModel) jTable1.getModel();
    modelo.setValueAt(aluno.getNome(), selectedRow, 1);
    modelo.setValueAt(aluno.getDataNascimento(), selectedRow, 2);
    modelo.setValueAt(aluno.getPeso(), selectedRow, 3);
    modelo.setValueAt(aluno.getAltura(), selectedRow, 4);
    ...
    HistoricoPesoDAO weightHistDao = new HistoricoPesoDAO();
    weightHistDao.salvarPesoHistorico(aluno.getCpf(), (float) aluno.getPeso(), aluno.getAltura(), dataCadastro);
